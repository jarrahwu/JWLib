...
import com.jw.xlib.R;

/**
 * @author jarrahwu 圆角的ImageView 可以设置圆角图片
 */
public class RoundImageView extends ImageView {

	Path clipPath;
	private RectF rect;
	private float radius = 5.0f; // 默认是5px
	private AQuery mAq;
	...
	public RoundImageView(Context context, AttributeSet attrs) {
		...
		this.radius = array.getFloat(R.styleable.ConnerImage_radius, 0.0f);
		array.recycle();
	}
	...
	public void ajaxImage(String url){
		mAq.id(this).image(url, false, true, 600, R.drawable.ic_launcher, new BitmapAjaxCallback(){
			@Override
